      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-xl font-semibold">
            <Shapes className="text-primary h-8 w-8" />
            <span>Manage Assets</span>
          </h1>
          <p className="text-muted-foreground mt-1 text-sm">View, add, and manage your assets efficiently</p>
        </div>

        <div>
          <Button onClick={() => handleOpenDialog()}>Add Asset Type</Button>
        </div>
      </div>
